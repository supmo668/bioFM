...
Output: write to `/Users/mo/github/personal/bioFM/.understand-anything/intermediate/batch-10.json` (single-file mode) OR `batch-10-part-<k>.json` (split mode, per Step B of your output protocol).

**IMPORTANT — output file naming:** the output file MUST be named exactly `batch-10.json` (or `batch-10-part-<k>.json`). Any other name is silently dropped by the merge script.
...
```json
{
 "projects/perturb-seq-eval/src/perturb_eval/data/__init__.py": [
  "projects/perturb-seq-eval/src/perturb_eval/data/download.py",
  "projects/perturb-seq-eval/src/perturb_eval/data/subsample.py"
 ],
 "projects/perturb-seq-eval/src/perturb_eval/data/download.py": [],
 "projects/perturb-seq-eval/src/perturb_eval/data/subsample.py": []
}
...
1. `projects/perturb-seq-eval/src/perturb_eval/data/__init__.py` (32 lines, language: `python`, fileCategory: `code`)
2. `projects/perturb-seq-eval/src/perturb_eval/data/download.py` (232 lines, language: `python`, fileCategory: `code`)
3. `projects/perturb-seq-eval/src/perturb_eval/data/subsample.py` (89 lines, language: `python`, fileCategory: `code`)
