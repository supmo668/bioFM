...
Output: write to `/Users/mo/github/personal/bioFM/.understand-anything/intermediate/batch-8.json` (single-file mode) OR `batch-8-part-<k>.json` (split mode, per Step B of your output protocol).

**IMPORTANT — output file naming:** the output file MUST be named exactly `batch-8.json` (or `batch-8-part-<k>.json`). Any other name is silently dropped by the merge script.
...
```json
{
 "libs/cellforge-agents/src/cellforge/backends/__init__.py": [
  "libs/cellforge-agents/src/cellforge/backends/base.py",
  "libs/cellforge-agents/src/cellforge/backends/mock.py"
 ],
 "libs/cellforge-agents/src/cellforge/backends/base.py": [],
 "libs/cellforge-agents/src/cellforge/backends/mock.py": []
}
...
1. `libs/cellforge-agents/src/cellforge/backends/__init__.py` (4 lines, language: `python`, fileCategory: `code`)
2. `libs/cellforge-agents/src/cellforge/backends/base.py` (17 lines, language: `python`, fileCategory: `code`)
3. `libs/cellforge-agents/src/cellforge/backends/mock.py` (49 lines, language: `python`, fileCategory: `code`)
