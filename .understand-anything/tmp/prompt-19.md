...
Output: write to `/Users/mo/github/personal/bioFM/.understand-anything/intermediate/batch-19.json` (single-file mode) OR `batch-19-part-<k>.json` (split mode, per Step B of your output protocol).

**IMPORTANT — output file naming:** the output file MUST be named exactly `batch-19.json` (or `batch-19-part-<k>.json`). Any other name is silently dropped by the merge script.
...
```json
{
 "projects/perturb-seq-eval/artifacts/v0.5.0/dry_run_summary.json": [],
 "projects/perturb-seq-eval/artifacts/v0.5.0/provenance.json": [],
 "projects/perturb-seq-eval/artifacts/v0.5.0/summary.json": []
}
```
...
1. `projects/perturb-seq-eval/artifacts/v0.5.0/dry_run_summary.json` (18 lines, language: `json`, fileCategory: `config`)
2. `projects/perturb-seq-eval/artifacts/v0.5.0/provenance.json` (16 lines, language: `json`, fileCategory: `config`)
3. `projects/perturb-seq-eval/artifacts/v0.5.0/summary.json` (451 lines, language: `json`, fileCategory: `config`)
