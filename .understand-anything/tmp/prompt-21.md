...
Output: write to `/Users/mo/github/personal/bioFM/.understand-anything/intermediate/batch-21.json` (single-file mode) OR `batch-21-part-<k>.json` (split mode, per Step B of your output protocol).

**IMPORTANT — output file naming:** the output file MUST be named exactly `batch-21.json` (or `batch-21-part-<k>.json`). Any other name is silently dropped by the merge script.
...
```json
{
 "projects/perturb-seq-eval/massgen_skill_draft/README.md": [],
 "projects/perturb-seq-eval/massgen_skill_draft/SKILL.md": [],
 "projects/perturb-seq-eval/massgen_skill_draft/skill.yaml": []
}
```
...
1. `projects/perturb-seq-eval/massgen_skill_draft/README.md` (51 lines, language: `markdown`, fileCategory: `docs`)
2. `projects/perturb-seq-eval/massgen_skill_draft/SKILL.md` (72 lines, language: `markdown`, fileCategory: `docs`)
3. `projects/perturb-seq-eval/massgen_skill_draft/skill.yaml` (57 lines, language: `yaml`, fileCategory: `config`)
